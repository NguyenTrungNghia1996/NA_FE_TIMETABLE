...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    public: {
      baseURL: process.env.NUXT_PUBLIC_BASE_URL || "https://api.testtkb.xepthoikhoabieu.com",
    ...
    // https://api.testtkb.xepthoikhoabieu.com //https://api.dungthutkb.xepthoikhoabieu.com
    // https://api.testtkb.xepthoikhoabieu.com //https://api.dungthutkb.xepthoikhoabieu.com
  },
  routeRules: {
    "/": { prerender: true },
