<template>
  <div class="p-2 md:p-4 bg-white min-h-full">
    <div class="flex flex-col lg:flex-row gap-2 mb-4 lg:items-center">
      ...
      <div class="flex flex-col w-full gap-2 lg:w-auto lg:flex-row lg:flex-wrap lg:justify-end">
        ...
        <a-button
          ...
          class="w-full lg:w-auto"
          :disabled="!settingStore.currentPermission">
          Tiết tránh xếp của cặp Lớp - Môn học
        </a-button>
        <a-button
          type="primary"
          @click="drawerSubjectOpen = true"
          class="w-full lg:w-auto"
          :disabled="!settingStore.currentPermission">
          Môn học của lớp
        </a-button>
    ...
    <a-modal
      ...
      :title="isEdit ? 'Chỉnh sửa lớp học' : 'Thêm mới lớp học'"
      @cancel="handleCancel"
      :width="700">
    ...
    <a-drawer
      ...
      title="Thiết lập tiết tránh xếp của cặp Lớp - Môn học"
      :footer="null"
      height="100vh"
      placement="bottom"
      @close="closeSubjectAvoid">
      <ClientOnly>
