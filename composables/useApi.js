...
class Supervisory {
  ...
  async list(data) {
    return await this.request.get(ENDPOINTS.SUPERVISORY, data);
  }
  async detail(data) {
    return await this.request.get(ENDPOINTS.SUPERVISORY_DETAIL, data);
  }
  async list_teacher_ids(data) {
    return await this.request.get(ENDPOINTS.SUPERVISORY_LIST, data);
  }
  async save_teacher_ids(data) {
    return await this.request.post(ENDPOINTS.SUPERVISORY_LIST, data);
  }
  async update(data) {
    return await this.request.put(ENDPOINTS.SUPERVISORY, data);
  }
  async delete(data) {
    return await this.request.delete(ENDPOINTS.SUPERVISORY, data);
  }
  async import_file(data) {
...
class ExamSubject {
  ...
  async list(data) {
    return await this.request.get(ENDPOINTS.EXAM_SUBJECT, data);
  }
  async detail(data) {
    return await this.request.get(ENDPOINTS.EXAM_SUBJECT_DETAIL, data);
  }
  async create(data) {
    return await this.request.post(ENDPOINTS.EXAM_SUBJECT, data);
  }
  async update(data) {
    return await this.request.put(ENDPOINTS.EXAM_SUBJECT, data);
  }
  ...
  async delete(data) {
    return await this.request.delete(ENDPOINTS.EXAM_SUBJECT, data);
  }
}
