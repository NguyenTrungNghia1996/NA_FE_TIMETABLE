<template>
  <div class="max-w-3xl mx-auto p-6 space-y-6">
    <h1 class="text-2xl font-bold">Demo: SelectExpertise (Tổ chuyên môn)</h1>

    <ClientOnly>
      <a-form :model="form" @finish="submit" layout="vertical">
        <SelectExpertise
          v-model="form.expertiseMultiple"
          label="Chọn nhiều tổ chuyên môn"
          name="expertiseMultiple"
          :multiple="true"
        />

        <SelectExpertise
          v-model="form.expertiseSingle"
          label="Chọn một tổ chuyên môn"
          name="expertiseSingle"
        />

        <SelectExpertise
          v-model="form.expertiseDisabled"
          label="Tổ chuyên môn bị khóa"
          name="expertiseDisabled"
          :disabled="true"
        />
      ...
      <a-modal v-model:open="modalOpen" title="Chọn tổ chuyên môn" @ok="submitModal">
        <SelectExpertise
          v-model="modalForm.modalExpertise"
          label="Tổ chuyên môn modal"
          name="modalExpertise"
        />
      </a-modal>
...
const propsTable = [
  ...
  { prop: 'label', type: 'String', default: 'Tổ chuyên môn', desc: 'Nhãn hiển thị trên form item' },
  { prop: 'name', type: 'String', default: 'tochuyenmon', desc: 'Tên trường trong form' },
  { prop: 'multiple', type: 'Boolean', default: 'false', desc: 'Cho phép chọn nhiều giá trị hay không' },
  { prop: 'placeholder', type: 'String', default: 'Chọn tổ chuyên môn', desc: 'Placeholder hiển thị' },
