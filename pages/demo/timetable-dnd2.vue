<template>
  <div class="min-h-screen bg-gray-50 p-4" @click="closeMenu">
    ...
    >
      ...
      <div class="flex justify-end gap-2 mt-6 border-t border-black pt-4">
        <a-button @click="cancelSubject" class="border border-black">Hủy</a-button>
        <a-button type="primary" @click="confirmSubject" class="border border-black">Xác nhận</a-button>
      </div>
    </a-modal>
  </div>
</template>
