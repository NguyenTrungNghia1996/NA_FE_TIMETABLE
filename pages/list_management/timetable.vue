      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <a-card type="inner" title="Ma trận thời khóa biểu">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <a-button :loading="exportModal.loadingKey === 'matrix-class-vertical'" :disabled="!!exportModal.loadingKey && exportModal.loadingKey !== 'matrix-class-vertical'" @click="exportMatrixClassVertical">
              Ma trận lớp - dọc
            </a-button>
          </div>
        </a-card>
...
const exportModal = reactive({
  ...
  options: {
    class: { showRoom: 0, showTeacher: 0 },
    school: { showRoom: 0, showTeacher: 0 },
    teacher: { showRoom: 0 },
  },
});
...
const openExportModal = record => {
  ...
  exportModal.options.class.showRoom = 0;
  exportModal.options.class.showTeacher = 0;
  exportModal.options.school.showRoom = 0;
  exportModal.options.school.showTeacher = 0;
  exportModal.options.teacher.showRoom = 0;
};
    ...
    () =>
      RestApi.timetable.export({
        params: {
          ...
          show_room: exportModal.options.school.showRoom,
  ...
  exportFile(
    () =>
      RestApi.timetable.export_class({
        params: {
          idtkb: exportModal.timetableId,
          show_room: exportModal.options.class.showRoom,
  ...
  exportFile(
    () =>
      RestApi.timetable.export_teacher({
        params: {
          idtkb: exportModal.timetableId,
          show_room: exportModal.options.teacher.showRoom,
        },
      }),
    "teacher",
  );
...
const exportMatrixClassVertical = () =>
  exportFile(() => RestApi.timetable.export_matrix_class_vertical({ params: { idtkb: exportModal.timetableId } }), "matrix-class-vertical");
