<template>
  <div class="p-2 md:p-4 bg-white min-h-full">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-2 mb-4">
      ...
      <a-button @click="drawerAvoidOpen = true" class="w-full md:w-auto" :disabled="!settingStore.currentPermission">Tiết tránh xếp</a-button>
    ...
    <a-drawer v-model:open="drawerAvoidOpen" title="Thiết lập tiết tránh xếp của lớp ôn tập" :footer="null" height="100vh" placement="bottom" @close="closeReviewClassAvoid">
      <ClientOnly>
        <ReviewClassAvoid ref="avoidRef" />
      </ClientOnly>
    </a-drawer>
  </div>
</template>
